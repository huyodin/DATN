...
<div class="container-lg mt-5 bg-white p-4">
    ...
    <a href="{{ route('admin.hotels.create') }}" class="btn btn-tour mb-3">Thêm khách sạn</a>
            ...
            @foreach($hotels as $index => $hotel)
                <tr>
                    ...
                    <td style="text-align: left; white-space: nowrap;">
                        <a href="{{ route('admin.hotels.edit', ['hotel' => $hotel->id]) }}" class="btn btn-warning">Chỉnh Sửa</a>
