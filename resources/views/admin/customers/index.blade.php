...
<div class="container-lg mt-5 bg-white p-4">
    ...
    <a href="{{ route('admin.customers.create') }}" class="btn btn-tour mb-3">Thêm Khách Hàng</a>
            ...
            @foreach($customers as $customer)
                <tr>
                    ...
                    <td>
                        ...
                        @if (auth()->user()->role != 1)
                            <form action="{{ route('admin.customers.destroy', $customer->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa?');">
                                @csrf
                                @method('DELETE')
