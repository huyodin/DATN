...
<div class="container-lg mt-5 bg-white p-4">
    ...
    <a href="{{ route('admin.vehicles.create') }}" class="btn btn-tour mb-3">Thêm xe mới</a>
    <table class="table">
        <thead>
            <tr>
                <th>Phương tiện</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.vehicles.edit', $vehicle->id) }}" class="btn btn-primary btn-sm">Sửa</a>
