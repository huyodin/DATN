...
<div class="container-lg mt-5 bg-white p-4">
    ...
    <a href="{{ route('admin.areanew.create') }}" class="btn btn-tour mb-3">Thêm khu vực mới</a>
    <table class="table">
        <thead>
            <tr>
                <th>Tên khu vực</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $area->name }}</td>
                <td>
                    <a href="{{ route('admin.areanew.edit', $area->id) }}" class="btn btn-primary btn-sm">Sửa</a>
