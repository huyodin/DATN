...
<div class="container-lg mt-5 bg-white p-4">
    ...
    <form action="{{ route('admin.areanew.update', $area->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <a href="{{ route('admin.areanew.index') }}" class="btn btn-secondary mt-3">Quay lại danh sách</a>
</div>
