...
class TourController
{
    ...
    public function create()
    {
        ...
        return view('admin.tours.create', compact('areas', 'hotels', 'vehicles', 'guides'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.tours.show', compact('tour', 'bookings', 'totalNumberOfPeople', 'area', 'hotel', 'vehicle', 'guide'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $guides = TourGuide::all();
        $tour = Tour::findOrFail($id);
        return view('admin.tours.edit', compact('tour', 'areas', 'hotels', 'vehicles', 'guides'));
    }
